-- books-2021-01-28.sql

-- phpMyAdmin SQL Dump
-- version 4.8.5
-- https://www.phpmyadmin.net/
--
-- Host: mysql.nightscrawl.net
...
winter2021_Books INNER JOIN winter2021_Categories ON
winter2021_Books.CategoryID = winter2021_Categories.CategoryID
...
# same command, shorter ailiasing
SELECT BookTitle, Category, Authors, b.description `BookDescription` FROM
winter2021_Books b INNER JOIN winter2021_Categories c ON
b.CategoryID = c.CategoryID
WHERE BookID=6

# shows all book titles, categories, authors, sorted by title ascending alpha
...
# shows all book titles, categories, authors, sorted by title ascending alpha
SELECT BookTitle, Category, Authors FROM
winter2021_Books b LEFT JOIN winter2021_Categories c ON
b.CategoryID = c.CategoryID
ORDER BY Category asc

# shows number of Books by Category
SELECT Category, count(*) `NumberOfBooks` FROM
winter2021_Books b LEFT JOIN winter2021_Categories c ON
b.CategoryID = c.CategoryID
